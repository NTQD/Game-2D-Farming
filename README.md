...
index 6ba71126d60f4978e829f2bb4686e8fe3b4515c7..7540665d765fe06f169eff08dc7b451e64f3b6ab 100644
--- a/README.md
+++ b/README.md
@@ -1,41 +1,48 @@
 # 2D Farming Game
...
+The player takes on the role of a shipwreck survivor who washes ashore on a tropical island. Your first task is to open the supply chest on the beach, gather the starter tools and seeds, and begin building a new life from scratch. From that moment onward survival revolves around completing four main story missions:
+
+1. **Đảm bảo an ninh lương thực** – till the soil, sow the starter seeds and successfully harvest the required crop varieties to secure a stable food supply.
+2. **Đảm bảo an ninh năng lượng** – explore the island to chop enough wood for nightly campfires and to stockpile the materials needed for future construction.
+3. **An cư** – use the gathered resources to assemble a sturdy shelter that meets the material checklist for a permanent home base.
+4. **Sống sót trở về** – once the first three objectives are complete, trade the surplus goods for blueprints and special parts, then craft a seaworthy boat and prepare enough provisions to brave the journey back to civilization.
+
+Throughout the scenario the survival HUD tracks hunger, warmth and elapsed days survived, rewarding efficient resource management and planning.
