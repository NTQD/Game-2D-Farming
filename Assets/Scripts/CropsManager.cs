...
public class CropsManager : MonoBehaviour
{
    ...
    public void SeedCrop(Vector3Int position, string name)
    {
        ...
        if (name == "corn")
        {
            ...
            cropSeeded.timeRemaining = 12; //assign time to grow (10x faster)
        ...
        else if (name == "parsley")
        {
            ...
            cropSeeded.timeRemaining = 6; //parsley 10x faster
        ...
        else if (name == "potato")
        {
            ...
            cropSeeded.position = position;
            cropSeeded.state = cropSeeded.state0;
            cropSeeded.timeRemaining = 9; //potato 10x faster
        ...
        else if (name == "strawberry")
        {
            ...
            cropSeeded.position = position;
            cropSeeded.state = cropSeeded.state0;
            cropSeeded.timeRemaining = 9; //strawberry 10x faster
        ...
        else if (name == "tomato")
        {
            ...
            cropSeeded.position = position;
            cropSeeded.state = cropSeeded.state0;
            cropSeeded.timeRemaining = 6; //tomato 10x faster
        ...
        if (crop.timerIsRunning) //if watered - timer is running
        {
            ...
            else
            {
                if (crop.name == "Parsley(Clone)") //parsley has less states of grow
                {
                    ...
                    {
                        crop.timeRemaining = 6; //time to next state (10x faster)
                    }
                }
                else
                {
                    ...
                    if (crop.state != crop.state5)
                    {
                        if (crop.name == "Corn(Clone)")
                            crop.timeRemaining = 12; //time to next state (10x faster)
                        if (crop.name == "Potato(Clone)")
                            crop.timeRemaining = 9; //time to next state (10x faster)
